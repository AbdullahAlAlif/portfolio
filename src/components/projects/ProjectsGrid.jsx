...
const ProjectsGrid = ({ showAll }) => {
  ...
  // Only show first 4 projects unless showAll is true
  const displayedProjects = showAll ? projects : projects.slice(0, 6);

  let gridProjects;
  if (selectProject) {
	gridProjects = selectProjectsByCategory;
  } else if (searchProject) {
	gridProjects = searchProjectsByTitle;
  } else {
	gridProjects = displayedProjects;
  }
  ...
  return (
	<section className="py-5 sm:py-10 mt-5 sm:mt-10">
	  ...
	  <div className="mt-10 sm:mt-16">
		...
		>
		  Search projects by title or filter by category and click on the project to view Github repository.
		</h3>
